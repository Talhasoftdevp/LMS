...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#classID").on("change", function() {
			var value = $(this).val();
			var fetchSubjects = '<?php echo base_url(); ?>app/add_teacher/fetch_assigned_Subjects';
			$.ajax({
				url: fetchSubjects,
				type: "post",
				data: {
		...
		// 	$('#slides').append('<tr id="row_' + id + '"><td><select class="slide_type" rel="' + slide_index + '" data-id="' + id + '" name="slide_type[]" id="slide_type_' + id + '"><option value="1">file</option><option value="2">url</option></select></td><td><input type="text" class="col-xs-10 col-sm-10" name="name[]" id="name_' + id + '"/></td> <td><input type="number" class="col-xs-10 col-sm-10" name="sort[]" id="sort_' + id + '"/></td> <td id="photo_' + id + '"><input type="file" class="col-xs-10 col-sm-12" name="photo[]" /></td> <td><button data-id="' + id + '" type="button" class="btn btn-danger btn-sm remove">X</button></td> </tr>');
		...
		// 		//alert(val);				
		// 		if (val == 1) {
		// 			$('#photo_' + cnt_id).html('<input type="file" class="col-xs-10 col-sm-12" name="photo[]" />');
		// 			$('#slide_type_' + cnt_id).attr('name', 'slide_type[]');
		// 			$('#name_' + cnt_id).attr('name', 'name[]');
		// 			$('#sort_' + cnt_id).attr('name', 'sort[]');

		// 		}
		// 		if (val == 2) {
		// 			$('#photo_' + cnt_id).html('<input type="text" class="col-xs-10 col-sm-12" name="photo[]" />');
		// 			$('#slide_type_' + cnt_id).attr('name', 'slide_type[]');
		// 			$('#name_' + cnt_id).attr('name', 'name[]');
		// 			$('#sort_' + cnt_id).attr('name', 'sort[]');
		// 		}
		...
		// 	}
		// 	if (val == 2) {
		// 		$('#photo_' + cnt_id).html('<input type="text" class="col-xs-10 col-sm-12" name="photo_o[]" />');
		// 		$('#slide_type_' + cnt_id).attr('name', 'slide_type_o[]');
		// 		$('#name_' + cnt_id).attr('name', 'name_o[]');
		// 		$('#sort_' + cnt_id).attr('name', 'sort_o[]');
		// 	}
