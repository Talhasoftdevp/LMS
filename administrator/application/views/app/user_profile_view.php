                                    ...
                                    <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo $action; ?>" id="<?php echo $this->uri->segment(2) . '_form'; ?>" method="post" role="form">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="name" value="<?php echo $record_info['user_name']; ?>" name="user_name" placeholder="Name" class="col-xs-10 col-sm-10" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="father_name" value="" name="password" placeholder="Leave Empty if you Don't Want To Change Password" class="col-xs-10 col-sm-10" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="cnic" value="<?php echo $record_info['email'] ; ?>" name="email" placeholder="email" class="col-xs-10 col-sm-10" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-4"> Mobile No</label>

                                                <div class="col-sm-9">
                                                    <input type="text" id="mobile_no" value="<?php echo $record_info['contact_no']; ?>" name="contact_no" placeholder="contact_no" class="col-xs-10 col-sm-10" />
                                                </div>
                                            </div>
                                            <div class="form-group">
