                                    ...
                                    <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo $action; ?>" id="<?php echo $this->uri->segment(2) . '_form'; ?>" method="post" role="form">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="cnic" value="<?php echo ($edit == TRUE) ? $record_info['email'] : ''; ?>" name="email" placeholder="email" class="col-xs-10 col-sm-10" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="mobile_no" value="<?php echo ($edit == TRUE) ? $record_info['contact_no'] : ''; ?>" name="contact_no" placeholder="contact_no" class="col-xs-10 col-sm-10" />
                                                </div>
                                            </div>
                                            <div class="form-group">
