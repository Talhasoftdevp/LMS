                        ...
                        <table class="table table-striped table-bordered table-hover" id="simple-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color:#26466D; color:white ;width:10%;text-align:center">Date</th>
                            ...
                            <tbody id="logs">
                                <?php foreach ($inbox as $inbox_data) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $inbox_data['sender_class']; ?></td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form class="form-horizontal" enctype="multipart/form-data" id="submit" action="" method="post" role="form">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-success active" onclick='window.location.href="<?php echo base_url() . "mail_box/mail_box/compose/" . $inbox_data["parent_id"] . "/" . $inbox_data["sender_id"] . "/" . $inbox_data["sender_name"] . "/" . $inbox_data["sender_class"] . "/" . $inbox_data["subject"] ?>"'>Reply</button>
