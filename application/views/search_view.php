...
<div class="row">
    ...
    <div class="col-md-3">
        <ul class="list-group">
            <li class="list-group-item active"><a href="<?php echo base_url(); ?>search">Individual</a></li>
    ...
    <div class="col-md-9">
    	<div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url(); ?>search/search" method="post" id="search_form" method="post" role="form">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
						...
						<div class="clearfix"></div>
						<input type="button" value="SUBMIT" id="search_submit" />
                    </div><!--col-->
                    </form>
			</div><!--panel-body-->
		</div><!--panel-->
