...
<div class="row">
    ...
    <div class="col-md-3">
        <ul class="list-group">
            ...
            <li class="list-group-item active"><a href="<?php echo base_url(); ?>aircraft">Vessel/Aircraft</a></li>
    ...
    <div class="col-md-9">
    	<div class="panel panel-primary">
        	<div class="panel-heading">Air Craft</div>
            <div class="panel-body">
                <form action="<?php echo base_url(); ?>aircraft/search" method="post" id="aircraft_form" method="post" role="form">
                    <div class="col-md-6">
                        <label for="search_terms">Search Term</label>
                        <input id="search_terms" value="" name="search_terms" type="text">                        
                    ...
                    <div class="col-md-6">                    	                    	
                        <label for="address">State/Prov</label>
    ...
    <iframe id="SearchReport" scrolling="yes" src=""></iframe>
    </div><!--col12-->
