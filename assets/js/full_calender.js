...
var FullCalendar = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  function listenToHoverBySelector(
    ...
    return listenBySelector(container, 'mouseover', selector, function (
      ev,
      matchedChild
    ) {
  ...
  var EventApi = /** @class */ (function () {
    ...
    EventApi.prototype.mutate = function (mutation) {
      ...
      if (instance) {
        ...
        var relevantEvents_1 = getRelevantEvents(
          eventStore,
          instance.instanceId
        );
        var eventConfigBase = {
      ...
      return buttonGroupStr.split(',').map(function (buttonName) {
        if (buttonName === 'title') {
          ...
          if ((customButtonProps_1 = calendarCustomButtons[buttonName])) {
            ...
            (buttonIcon = theme.getCustomButtonIconClass(
              customButtonProps_1
            )) ||
  ...
  */
  ...
  var CalendarDataManager = /** @class */ (function () {
    ...
    CalendarDataManager.prototype._handleAction = function (action) {
      ...
      var eventSourceLoadingLevel = computeEventSourceLoadingLevel(
        eventSources
      );
        ...
        if (raw[optionName] === currentRaw[optionName]) {
          ...
          if (
            ...
            if (optionName in this.currentCalendarOptionsRefined) {
              ...
              refined[optionName] = this.currentCalendarOptionsRefined[
                optionName
              ];
            }
          } else if (refiners[optionName]) {
  ...
  */
  ...
  function computeCanVGrowWithinCell() {
    ...
    el.style.left = '0';
    el.innerHTML =
      '<table style="height:100px"><tr><td><div style="height:100%"></div></td></tr></table>';
    document.body.appendChild(el);
  ...
  */
  ...
  var SimpleScrollGrid = /** @class */ (function (_super) {
    ...
    SimpleScrollGrid.prototype.render = function () {
      ...
      return createElement(
        'table',
        { className: classNames.join(' '), style: { height: props.height } },
        ...
        if (!documentPointer.wasTouchScroll) {
          if (
            ...
            if (
              unselectAuto &&
              (!unselectAuto ||
                !elementClosest(documentPointer.downEl, unselectCancel))
            ) {
  ...
  */
  ...
  function limitByMaxHeight(
    ...
    limitEvents(hiddenCnts, segIsHidden, colPlacements, true, function (
      placement
    ) {
  ...
  function limitByMaxEvents(
    ...
    limitEvents(hiddenCnts, segIsHidden, colPlacements, false, function (
      placement,
      levelIndex
    ) {
        ...
        props.cells.map(function (cell, col) {
          ...
          return createElement(TableCell, {
            ...
            showDayNumber:
              ...
              showWeekNumber /* for spacing, we need to force day-numbers if week numbers */,
  ...
  var Table = /** @class */ (function (_super) {
    ...
    Table.prototype.render = function () {
      ...
      return createElement(
        ...
        createElement(NowTimer, { unit: 'day' }, function (
          nowDate,
          todayRange
        ) {
          return createElement(
              ...
              createElement(
                ...
                props.cells.map(function (cells, row) {
                  return createElement(TableRow, {
                    ...
                    eventSelection: props.eventSelection,
                    bgEventSegs: bgEventSegsByRow[row].filter(
                      isSegAllDay
                    ) /* hack */,
